...
void MX_XSPI2_Init(void)
{
  ...
  hxspi2.Init.FifoThresholdByte = 8;
  ...
  hxspi2.Init.ChipSelectBoundary = HAL_XSPI_BONDARYOF_16B;
  hxspi2.Init.MaxTran = 0;
  hxspi2.Init.Refresh = 400;
  ...
  */
    ...
    */
    GPIO_InitStruct.Pin = GPIO_PIN_8|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6
                          |GPIO_PIN_9|GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_0
                          |GPIO_PIN_11|GPIO_PIN_3|GPIO_PIN_1;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_XSPI_MspDeInit(XSPI_HandleTypeDef* xspiHandle)
{
  ...
  /* USER CODE END XSPI2_MspDeInit 0 */
    ...
    PN1     ------> XSPIM_P2_NCS1
    */
    HAL_GPIO_DeInit(GPION, GPIO_PIN_8|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6
                          |GPIO_PIN_9|GPIO_PIN_2|GPIO_PIN_10|GPIO_PIN_0
                          |GPIO_PIN_11|GPIO_PIN_3|GPIO_PIN_1);
